...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'misis_media', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\MisMed\\MediaBundle\\Entity'))), 'MisMed\\MediaBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('MisMedMediaBundle' => 'MisMed\\MediaBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_3a6b724a379f2918992e0be5070d2a92c06fdb2ab769291e6b8e7494489a0a83');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\MisMed\\MediaBundle/Resources/views'), 'MisMedMedia');
        $instance->addPath(($this->targetDirs[3].'\\src\\Pages\\AboutBundle/Resources/views'), 'PagesAbout');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('70c4ce567f4ddce040fd46f21363c29fd304e75f');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('567415459c97d8.74084539')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'MisMedMediaBundle' => 'MisMed\\MediaBundle\\MisMedMediaBundle',
                'PagesAboutBundle' => 'Pages\\AboutBundle\\PagesAboutBundle',
            ...
            'secret' => '70c4ce567f4ddce040fd46f21363c29fd304e75f',
            'locale' => 'en',
            ...
            'kernel.secret' => '70c4ce567f4ddce040fd46f21363c29fd304e75f',
